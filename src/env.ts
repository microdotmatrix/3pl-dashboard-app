...
export const env = createEnv({
  server: {
    ...
    MEMBRANE_TENANT_KEY: z.string().min(1),
  ...
  runtimeEnv: {
    ...
    MONDAY_STORAGE_TRACKING_BOARD_ID:
      process.env.MONDAY_STORAGE_TRACKING_BOARD_ID,
    MONDAY_RECEIVING_BOARD_ID: process.env.MONDAY_RECEIVING_BOARD_ID,
    MONDAY_SPECIAL_PROJECTS_BOARD_ID:
      process.env.MONDAY_SPECIAL_PROJECTS_BOARD_ID,
    MEMBRANE_WORKSPACE_KEY: process.env.MEMBRANE_WORKSPACE_KEY,
    MEMBRANE_WORKSPACE_SECRET: process.env.MEMBRANE_WORKSPACE_SECRET,
    MEMBRANE_TENANT_KEY: process.env.MEMBRANE_TENANT_KEY,
